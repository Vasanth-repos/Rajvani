# Dataset Card: Rajasthan-ASR-MTR

## Dataset Description
- **Language / Dialect:** Mewari (मेवाड़ी - `MTR`)
- **Primary Regions:** Udaipur, Chittorgarh, Rajsamand, Bhilwara
- **Script:** Devanagari
- **Audio Hours:** ~3.1 hrs
- **Total Utterances:** 420 samples across 32 native speakers
